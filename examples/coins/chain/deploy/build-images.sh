...
Environment:
  ...
  COINS_INDEXER_IMAGE      Indexer image tag. Default: nunchi-coins-indexer:latest
...
echo "saving indexer image"
docker save "$indexer_image" -o "$out_dir/coins-chain-indexer.tar"
...
echo "wrote $out_dir/coins-chain-indexer.tar"
