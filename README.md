...
This workspace pins `commonware-*` crates to **2026.9.0**.
...
* Mid-sync glue metadata from v2026.7.0 cannot resume after upgrading to v2026.9.0; clear or re-sync any node that crashed mid state-sync before the bump.
