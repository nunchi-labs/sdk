...
pub struct MarketResponse {
    ...
    pub oracle_writer: String,
    pub clob_market: Option<String>,
    ...
    pub long_open_interest: String,
    pub short_open_interest: String,
    pub matched_open_interest: String,
...
impl From<Market> for MarketResponse {
    fn from(market: Market) -> Self {
        Self {
            ...
            oracle_writer: encode_hex(&market.oracle_writer),
            clob_market: market.clob_market.as_ref().map(encode_hex),
            ...
            liquidation_reward_bps: market.liquidation_reward_bps,
            mark_price: market.mark_price.to_string(),
            index_price: market.index_price.to_string(),
            long_open_interest: market.long_open_interest.to_string(),
            short_open_interest: market.short_open_interest.to_string(),
            matched_open_interest: market.matched_open_interest().to_string(),
